...
if ($parts) {
    foreach ($parts as $part) {
        echo $part['partID'] . ' ' . $part['partName'] . ' ' . $part['partTypeName'] . ' ' . $part['brandName'] . ' ' . $part['price'] . ' ' . $part['compatibleWith'] . '<br>';
        ...
        // Add Delete button with simple confirmation
        echo "<form method='post' action=''>
        <input type='hidden' name='partID' value='{$part['partID']}'>
        <input type='submit' name='deletePart' value='Delete' onclick='return confirm(\"Are you sure you want to delete this part?\");'>
        </form>";
